...
To show that the small triangle is a good pattern, a winning patterns are shown in illustration \ref{fig:yav_smallTriangleWin1}. This forces the black player to loose by a force move. Also its possible to turn a pattern by 120 Degree, with that in mind there are at least three possible winning situations with this simple pattern. If a opponent player try to form a triangle its recommendet to stop him as soon es possible.\cite{yvalathBGG}
